...
Route::prefix('/pengelola')->namespace('App\Http\Controllers')->group(function(){
    Route::match(['post', 'get'],'login', [PengelolaController::class, 'login']);
        ...
        Route::get('member', 'PengelolaController@member')->name('indexmember');
        Route::get('lokasi', 'PengelolaController@indexlokasi');
        Route::post('Pengelola/member', 'PengelolaController@createmember')->name('tambahmember');
        Route::get('/Pengelola/hapus/{id}', 'PengelolaController@hapusmember')->name('hapusmember');
